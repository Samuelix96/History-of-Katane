...
import { useGetArmorQuery, useGetArmorByTitleQuery, useAddArmorMutation } from '../api/apiSlice';
...
const Armor = () =>
{
  ...
  const uploadToCloudinary = async (img, image2, image3, image4, image5) =>
  {
    ...
    try
    {
      const response = await fetch(`${ process.env.REACT_APP_SERVER_URL }/armors/cloudUpload`, {
        method: 'POST',
        body: filesData
      });
